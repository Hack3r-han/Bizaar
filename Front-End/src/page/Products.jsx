...
function ProductList (props) {
    ...
    function fetchProducts() {
            ...
            fetch("https://api-e-collectic.vercel.app/products") //CAMBIAR PARA NUESTRO BBDD
            .then((response) => {
                if (!response.ok) {
    ...
    function deleteProduct(id) {
        fetch("https://api-e-collectic.vercel.app/products/" + id, { //CAMBIAR PARA NUESTRO BBDD
            method: "DELETE",
        })
        .then((response) => {
            if (!response.ok) {
...
function ProductForm(props) {
    ...
    function handleSubmit(event) {
        ...
        if (props.product.id) {
            // update the product
            fetch("https://api-e-collectic.vercel.app/products/" + props.product.id, { //CAMBIAR PARA NUESTRO BBDD
                method: "PATCH",
                headers: {
